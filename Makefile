...
PROJECTFILE = $(or $(wildcard search*.cpp $(EXECUTABLE).cpp), main.cpp)
...
REMOTE_PATH := Desktop/eecs281f23/eecs281_$(EXECUTABLE)_sync
...
# lab1: lab1.cpp sorting.h // executable
# OR

# sorting.o: sorting.cpp sorting.h
# lab1.o: lab1.cpp sorting.o 
# OR
